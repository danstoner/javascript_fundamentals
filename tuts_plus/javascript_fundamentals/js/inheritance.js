(function() {
    ...
    console.log(myRect instanceof Rectangle);   // now a Rectangle, not just an object

    function Square(sidesLength) {
	this.sides = [sidesLength, sidesLength, sidesLength, sidesLenght];
    }
	...
	this.getArea = function() {
	    ...
	    return Math.sqrt(semiperimeter * (semiperimeter - sideALength) *
			     (semiperimeter - sideBLength) * (semiperimeter - sideCLength));
	}
    }
    Triangle.prototype = new Shape2d();
    Triangle.prototype.constructore = Triangle;
